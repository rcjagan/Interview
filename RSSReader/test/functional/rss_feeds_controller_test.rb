...
class RssFeedsControllerTest < ActionController::TestCase
  ...
  test "should create rss_feed" do
    assert_difference('RssFeed.count') do
      post :create, rss_feed: { description: @rss_feed.description, link: @rss_feed.link, title: @rss_feed.title }
    end
  ...
  test "should update rss_feed" do
    put :update, id: @rss_feed, rss_feed: { description: @rss_feed.description, link: @rss_feed.link, title: @rss_feed.title }
    assert_redirected_to rss_feed_path(assigns(:rss_feed))
  end
